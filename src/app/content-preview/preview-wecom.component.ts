...
import {
  APPConfigModel, AuthoringTemplateModel, MappingModel, paginateModelChild, ContentModel, ToBeShareModel, ToPreviewModel, PreviewModel, ATConfig, WeiBo, WeCom, PreviewDataModel, PreviewUIDataModel,
} from '../../model/index';
/* eslint-enable @typescript-eslint/no-unused-vars */

@Component({
  selector: 'preview-wecom',
  templateUrl: './preview-wecom.component.html',
  styleUrls: [],
})
export class PreviewWeComComponent extends PreviewComponent implements OnInit, OnChanges { // eslint-disable-line import/prefer-default-export
  // @Input() previewItems!: ContentModel[];
  // @Input() previewOption!: any;
  @Input() shareConfig!: WeCom;
  ...
  // static  async getRichTextContent(data) { // static is much more inconvenient, which requires using ClassName instead of this
