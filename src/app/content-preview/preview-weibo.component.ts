...
@Component({
  selector: 'preview-weibo',
  templateUrl: './preview-weibo.component.html',
  styleUrls: [],
})
export class PreviewWeiBoComponent extends PreviewComponent implements OnInit, OnChanges { // eslint-disable-line import/prefer-default-export
// @Input() previewItems!: ContentModel[];
// @Input() previewOption!: any;
  @Input() shareConfig!: WeiBo;
